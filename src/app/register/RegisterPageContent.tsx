      ...
      <div className="auth-left">
        <div className="auth-left-content">
          ...
          <div className="auth-hero-text">
            <div className="hero-label">{t('register.badge')}</div>
            <h1 className="hero-headline">
              {t('register.headline1')}<br />
              <span className="hero-accent">{t('register.headline2')}</span>
            </h1>
            <p className="hero-sub">{t('register.sub')}</p>
          </div>

          <div className="auth-steps">
            {[
              { n: '01', label: t('register.step1') },
              { n: '02', label: t('register.step2') },
              { n: '03', label: t('register.step3') },
            ].map((s, i) => (
      ...
      <div className="auth-right">
        <div className="auth-form-container">
          <div className="auth-form-header">
            <p className="form-eyebrow">{t('register.panel')}</p>
