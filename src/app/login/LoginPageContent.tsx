  ...
  return (
    <div className="auth-root">
      ...
      <div className="auth-left">
        <div className="auth-left-content">
          ...
          <div className="auth-hero-text">
            <div className="hero-label">{t('login.badge')}</div>
            <h1 className="hero-headline">
              {t('login.headline1')}<br />
              <span className="hero-accent">{t('login.headline2')}</span>
            </h1>
            <p className="hero-sub">{t('login.sub')}</p>
          </div>
      ...
      <div className="auth-right">
        <div className="auth-form-container">
          <div className="auth-form-header">
            <p className="form-eyebrow">{t('login.panel')}</p>
      ...
      <style>{`
        ...
        .beam-1 { width:640px; height:640px; background:radial-gradient(circle,#6366f1 0%,transparent 70%); top:-200px; left:-100px; animation-delay:0s; }
        .beam-2 { width:480px; height:480px; background:radial-gradient(circle,#8b5cf6 0%,transparent 70%); bottom:-100px; right:-80px; animation-delay:-4s; }
        .beam-3 { width:320px; height:320px; background:radial-gradient(circle,#06b6d4 0%,transparent 70%); top:40%; left:45%; opacity:0.07; animation-delay:-7s; }
        ...
        @keyframes driftBeam { from{transform:translate(0,0) scale(1)} to{transform:translate(30px,20px) scale(1.08)} }
        ...
        .hero-label { font-family:'DM Mono',monospace; font-size:10px; font-weight:500; color:#6366f1; letter-spacing:3px; margin-bottom:16px; }
        .hero-headline { font-family:'Syne',sans-serif; font-size:clamp(36px,4vw,52px); font-weight:800; line-height:1.1; letter-spacing:-1.5px; color:rgba(255,255,255,0.95); margin-bottom:20px; }
        .hero-accent { background:linear-gradient(135deg,#818cf8 0%,#c084fc 100%); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; }
        .hero-sub { font-size:14.5px; color:rgba(255,255,255,0.45); line-height:1.65; max-width:340px; }
        .auth-feature-list { display:flex; flex-direction:column; gap:12px; }
        .auth-feature { display:flex; align-items:center; gap:12px; font-size:13.5px; color:rgba(255,255,255,0.55); animation:fadeInUp 0.5s ease both; }
        .feature-dot { width:6px; height:6px; border-radius:50%; background:linear-gradient(135deg,#6366f1,#8b5cf6); flex-shrink:0; box-shadow:0 0 8px rgba(99,102,241,0.6); }
        @keyframes fadeInUp { from{opacity:0;transform:translateY(10px)} to{opacity:1;transform:translateY(0)} }
        .auth-right { width:480px; flex-shrink:0; display:flex; align-items:center; justify-content:center; padding:60px 48px; position:relative; z-index:1; background:linear-gradient(180deg,rgba(99,102,241,0.03) 0%,transparent 50%); }
        ...
        .form-eyebrow { font-family:'DM Mono',monospace; font-size:10px; font-weight:500; color:#6366f1; letter-spacing:3px; margin-bottom:10px; }
        ...
        .form-subtitle { font-size:13.5px; color:rgba(255,255,255,0.4); line-height:1.5; }
        .auth-switch-link { margin-top:24px; text-align:center; font-size:13px; color:rgba(255,255,255,0.35); }
        .auth-switch-link a { color:#818cf8; text-decoration:none; font-weight:600; transition:color 150ms; }
